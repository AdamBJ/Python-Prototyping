...
class TestFieldWidthMethods(unittest.TestCase):
    ...
    def test_bad_input(self):
        ...
        pext_marker_stream = BitStream(1)
    ...
    def test_simple(self):
        ...
        pext_marker_stream = BitStream(int('100010001000', 2))
        idx_marker_stream = BitStream(1)
        pack_size = 64
    ...
    def test_simple2(self):
        ...
        pext_marker_stream = BitStream(int('10000011000', 2))
        idx_marker_stream = BitStream(1)
        pack_size = 64
        self.assertEqual(field_width.calculate_field_widths
    ...
    def test_multpack(self):
        ...
        pext_marker_stream = BitStream(int('000000100000000000011000', 2))
    ...
    def test_multpack2(self):
        ...
        pext_marker_stream = BitStream(int('12f051200f31011111', 16))
    ...
    def test_multpack3(self):
        ...
        pext_marker_stream = BitStream(int('1010000011111001100111110000000011011010', 2))
    ...
    def test_multpack4(self):
        ...
        pext_marker_stream = BitStream(int('100000011000000110000001', 2))
