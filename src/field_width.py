...
def calculate_field_widths(field_width_stream_wrapper, idx_marker_stream_wrapper, pack_size):
    ...
    E.g. field_width_stream_wrapper.value = 11101110111, idx_marker_stream_wrapper.value = 1,
    output =  [3,3]
    """
...
def process_pack(field_width_stream_wrapper, field_widths, field_start, non_zero_pack_idx,
                 pack_size):
    """Extract field widths from pack in field_width_stream_wrapper.value indexed by non_zero_pack_idx.
